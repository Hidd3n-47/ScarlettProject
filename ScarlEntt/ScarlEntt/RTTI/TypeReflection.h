...
public:
    ...
    template <typename T>
    static void SetValueFromString(T& value, const std::string& stringValue);
};
...
// --------- Sets. ---------
template <typename T>
inline void TypeReflection::SetValueFromString(T& value, const std::string& stringValue)
{
    throw std::runtime_error("Failed to get reflection value for type: " + std::string{ typeid(T).name() });
}

template <>
inline void TypeReflection::SetValueFromString<float>(float& value, const std::string& stringValue)
{
    value = std::stof(stringValue);
}

template <>
inline void TypeReflection::SetValueFromString<std::string>(std::string& value, const std::string& stringValue)
{
    value = stringValue;
}

template <>
inline void TypeReflection::SetValueFromString<ScarlettMath::Vec3>(ScarlettMath::Vec3& value, const std::string& stringValue)
{
    ...
    const std::string value1 = stringValue.substr(0, firstCommaPosition);
    const std::string value2 = stringValue.substr(firstCommaPosition + 1, secondCommaPosition - firstCommaPosition - 2);
    const std::string value3 = stringValue.substr(secondCommaPosition + 1);

    value = ScarlettMath::Vec3(std::stof(value1), std::stof(value2), std::stof(value3));
}

template <>
inline void TypeReflection::SetValueFromString<ScarlettMath::Vec4>(ScarlettMath::Vec4& value, const std::string& stringValue)
{
    const size_t firstCommaPosition = stringValue.find_first_of(',');
    const size_t secondCommaPosition = stringValue.find(',', firstCommaPosition + 1);
    ...
    const std::string value1 = stringValue.substr(0, firstCommaPosition);
    const std::string value2 = stringValue.substr(firstCommaPosition + 1, secondCommaPosition - firstCommaPosition - 2);
    const std::string value3 = stringValue.substr(secondCommaPosition + 1, thirdCommaPosition - secondCommaPosition - 2);
    const std::string value4 = stringValue.substr(thirdCommaPosition + 1);

    value = ScarlettMath::Vec4{ std::stof(value1), std::stof(value2), std::stof(value3), std::stof(value4) };
}

template <>
inline void TypeReflection::SetValueFromString<ScarlettMath::Quat>(ScarlettMath::Quat& value, const std::string& stringValue)
{
