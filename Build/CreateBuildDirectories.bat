...
echo ===================================================================================================================
echo:
:: Get the directory prior to where the .bat file is located (since .bat is in 'Project/Build').
...
:: Recursively loop through all directories starting from the directory previous to the .bat file's directory.
